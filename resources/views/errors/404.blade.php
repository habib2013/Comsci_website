...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    <div class="page">
      <!-- Page content-->
      <section class="section section-single context-dark bg-cover" style="background-image: url({{asset('images/bg-image-3.jpg')}});">
    ...
    <div class="preloader"> 
      <div class="preloader-logo"><img src="{{asset('images/logo-default-317x71.png')}}" alt="" width="317" height="71" srcset="images/logo-default-551x124.png 2x"/>
      </div>
