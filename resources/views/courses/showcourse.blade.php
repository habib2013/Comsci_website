  ...
  <div class="breadcrumbs-custom-inner">
          <div class="container breadcrumbs-custom-container">
            <div class="breadcrumbs-custom-main">
              <h6 class="breadcrumbs-custom-subtitle title-decorated">Course</h6>
              <h1 class="breadcrumbs-custom-title">Course details</h1>
            </div>
          ...
          <div class="row row-50">
            <div class="col-lg-8">
              <article class="post-creative">
                <h3 class="post-creative-title">{{$showcourse->code}}</h3>
                <ul class="post-creative-meta">
                  <li><span class="icon mdi mdi-calendar-clock"></span>
                    <time datetime="2018">{{$showcourse->time}}</time>
                  </li>
                  <li><span class="icon mdi mdi-tag-multiple"></span><a href="#">{{$showcourse->day}}</a></li>
                </ul>
                <p><b>Course name:</b> {{$showcourse->name}}</p>
                <h5><b>Course description:</b> {!!$showcourse->description!!}</h5>
            ...
            <div class="col-lg-4">
              ...
              <h4>Lecturer's profile</h4><br>
                <div class="profile-thin-aside"><img class="profile-thin-image" src="{{$showcourse->user->profile->profileImage()}}" alt="" width="168" height="268"/><a class="profile-thin-contact-button" href="/cdn-cgi/l/email-protection#6c4f"><span class="icon mdi mdi-email-outline"></span><span class="icon mdi mdi-email-outline"></span></a>
                </div>
                <div class="profile-thin-main">
                  <p class="profile-thin-title"><a href="/profile/{{$showcourse->user->id}}">{{$showcourse->user->name}} </a></p>
                  <p class="profile-thin-subtitle">{{$showcourse->user->title ?? 'No description available'}}</p>
                  <p></p>
